...
$exemple = array();
$form = array();
$host = $_SERVER['http://mail.u7996.mass.hc.ru'];
$ref = $_SERVER['mail.u7996.mass.hc.ru'];

//$host = $_SERVER['http://webmail.hostinger.com.ua'];
//$ref = $_SERVER['mx1.hostinger.com.ua'];
...
$form['form-1'] = array(
	'fields' => array(
		'name' => array(
			...
			'messages' => array(
				...
				'minlength' => 'Заполните пожалуйста ваше имя',
	...
	'cfg' => array(
		...
		'ajax' => true,
		'validate' => true,
		'from_email' => 'bender988@gmail.com',
		'from_name' => 'Заявка Ремонт Москва',
		'to_email' => 'timsavin@yandex.ru',
		...
		'okay' => 'Сообщение успешно отправлено',
		'fuck' => 'К сожалению сообщение не отправленно',
		'spam' => 'Cпам робот',
...
$form['form-2'] = array(
	...
	'cfg' => array(
		'charset' => 'utf-8',
		'subject' => 'Закажите замер сейчас!',
		'title' => 'Закажите замер сейчас!',
		'ajax' => true,
		'validate' => true,
		'from_email' => 'bender988@gmail.com',
        'from_name' => 'Заявка Ремонт Москва',
